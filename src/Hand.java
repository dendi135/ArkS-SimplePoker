...
public class Hand {
	...
	public int getCombination(Card[] myCards) {
		...
		if (royalFlush(combination) == 1) {
			...
			return 9;
		} else if (highCard(combination) == 10) {
			return 10;
		} else
			return 0;
	}
	...
	/*
	 * public int getCombinationTest(Card[] myCards) { String firstCard =
	 * myCards[0].toString().toLowerCase(); String secondCard =
	 * myCards[1].toString().toLowerCase(); String thirdCard =
	 * myCards[2].toString().toLowerCase(); String fourthCard =
	 * myCards[3].toString().toLowerCase(); String fifthCard =
	 * myCards[4].toString().toLowerCase(); String[] fcValue = firstCard.split(" ");
	 * String[] scValue = secondCard.split(" "); String[] tcValue =
	 * thirdCard.split(" "); String[] focValue = fourthCard.split(" "); String[]
	 * fifcValue = fifthCard.split(" "); List<String> combination = new
	 * ArrayList<String>(); combination.add("sixg"); combination.add("ten");
	 * combination.add("sixs"); combination.add("sixf"); combination.add("ten"); //
	 * -----------------------------------------------------------------------------
	 * --------------------- System.out.println("Your have this cards: " +
	 * combination); //
	 * -----------------------------------------------------------------------------
	 * --------------------- if (royalFlush(combination) == 1) { return 1; } else if
	 * (straightFlush(combination) == 2) { return 2; } else if
	 * (fourOfAKind(combination) == 3) { return 3; } else if (fullHouse(combination)
	 * == 4) { return 4; } else if (flush(combination) == 5) { return 5; } else if
	 * (straight(combination) == 6) { return 6; } else if (threeOfAKind(combination)
	 * == 7) { return 7; } else if (twoPair(combination) == 8) { return 8; } else if
	 * (pair(combination) == 9) { return 9; } else return 0; }
	 */
	...
	private int fourOfAKind(List<String> combination) { 
